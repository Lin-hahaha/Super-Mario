...
public class GameUtil {
    //背景
    public static BufferedImage bg_1 = null;
    public static BufferedImage bg_2 = null;
    //马里奥向左跳跃
    ...
    //图片路径前缀,方便调用
    public static String path = System.getProperty("user.dir") + "/imgs/";

    //初始化图片
    public static void init(){
        //加载背景图片
        try {
            bg_1 = ImageIO.read(new File( path+"bg.png"));
            bg_2 = ImageIO.read(new File(path+"bg2.png"));
            //加载马里奥向左站立
